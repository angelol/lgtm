import { checkNodeVersion, verifyNodeVersion, isApiAvailable, features, DEFAULT_VERSION_CONFIG } from '../../src/utils/version';
...
describe('Version Check Utility', () => {
  ...
  describe('checkNodeVersion', () => {
    ...
    test('uses default config when none provided', () => {
      ...
      expect(result.supportedRange).toBe(`>=${DEFAULT_VERSION_CONFIG.minVersion} <${DEFAULT_VERSION_CONFIG.maxVersion}`);
    });
  });
